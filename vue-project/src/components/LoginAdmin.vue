                ...
                <div class="form-group">
                    <div class="input-group">
                        <div class="form-floating">
                            <Field name="password" v-bind:type="showPassword ? 'text' : 'password'" class="form-control" placeholder="Mật khẩu" v-model="admin.password"/>
    ...
    data() {
        const adminSchema = yup.object().shape({
            adminname: yup
                ...
                .min(3, "Tên chứa ít nhất 3 ký tự")
